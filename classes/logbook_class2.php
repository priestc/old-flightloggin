...
class logbook extends currency
{
	...
	function make_flying_form()
	{
		if($this->mode != "All")
			...
			$show_all_entries = "<span style=\"display:inline\" class=\"fake_anchor\" id=\"unhide_entries_text_link\">&nbsp;</span>
